...
\begin{abstract}
  ...
  Effectively mapping tasks on parallel systems is crucial to assure performance in demanding applications. 
  ...
  Even though centralized rescheduling of work has been a viable solution to mitigate this problem, this efficiency of such an approach is not able to keep up with the increasing size of shared memory platforms. 
  To efficiently solve load imbalance today, and in the years to come, we should prioritize strategies developed for large scale multi-computers, decentralized approaches.
