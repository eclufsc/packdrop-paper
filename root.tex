...
\begin{abstract}
  ...
  We evaluated our approach in two different parallel platforms, using both synthetic workloads and a molecular dynamics (MD) benchmark. Our solution was able to achieve speedups of up to $3.75$x and $1.15$x on rescheduling time, when compared to other centralized and distributed approaches, respectively. Moreover, it improved the execution time of MD in up to $1.34$x and $1.22$x, when compared to a scenario without load balancing on two different platforms.
%\lipsum[9]
% 165 words
