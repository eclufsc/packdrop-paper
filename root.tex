...
\begin{abstract}
  ...
  As platforms and applications grow, load imbalance becomes a priority issue. %, and the previous algorithms are unable to deal with it as efficiently.
...
% Últimos artigos que achei, inclusive do Gustafson pareciam usar, apesar de me parecer bem estranho
