...
\begin{abstract}
  ...
  Even though centralized rescheduling of work has been a viable solution to mitigate this problem, the efficiency of such an approach is not able to keep up with the increasing size of shared memory platforms.
