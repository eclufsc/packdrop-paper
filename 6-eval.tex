...
\begin{table}[!ht]
	...
	PackDrop & $55.984$s & $55.51554$s & $143.103$ms \\ 
...
These results also portray the addition of communication overheads in different topologies ($2$, $4$, and $6$ \tofix{peers} for Ring, $2$D, and $3$D Mesh, respectively). %Can I use peers here?
