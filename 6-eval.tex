...
\textit{Refine} was excluded from this evaluation since this LeanMD input presents more data than Refine is able to process in a \tofix{reasonable time}. % Nenhuma ideia de tempo geral? O que é razoável?
