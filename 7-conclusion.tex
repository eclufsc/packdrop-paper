...
In this scenario, rescheduling time of \textit{PackDrop} and \textit{Distributed} were \tofix{statistically equal}, although both had a time up to $3$ orders of magnitude faster than any centralized approach. %Add some data to reinforce this
