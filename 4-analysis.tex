...
Here we use $f=2$, in order to avoid network congestion in shared clusters. % What does shared cluster mean in this context?
...
Finally, line 14 will have a complexity equal to the higher number of packs migrated by an overloaded PE. % higher? largest? 
