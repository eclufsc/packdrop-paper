...
\tofix{Higher values of $ps$ will lower communication complexity, but may lead to an imprecise scheduling.
In our implementation, we chose a moderate value of $ps$ (recall Equation~\ref{eq:ps}) varying to smaller values according to system load.}
...
\todo[inline]{Please, fix the highlighted sentences and correlate them to Equation~\ref{eq:ps}. How do you vary the value of $ps$? How this correlate to application specific characteristics?}
