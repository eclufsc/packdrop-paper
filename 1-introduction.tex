...
Few are the distributed strategies in the domain of global rescheduling, but their effectiveness is notable~\cite{diffus,grapevine}.
...
Our approach is based on the idea of grouping tasks prior to migration decisions in batches, decreasing communication overhead in algorithm decision time and preserving locality of migrated tasks, improving application makespan~\cite{Paudel2013wslocal}.
