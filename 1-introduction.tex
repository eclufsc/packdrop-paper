...
In this paper, we present the concept of \textit{Batch Task Migration} and a novel distributed global rescheduling algorithm that applies this technique called \textit{PackDrop}.
...
\begin{enumerate}
	...
	\item A novel distributed rescheduling algorithm, using our \textit{Batch Task Migration} approach named \textit{PackDrop}.
	\item An implementation of our algorithm in a well-known distributed framework as well as a performance evaluation of this implementation.
\end{enumerate}
