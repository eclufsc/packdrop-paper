...
\todo[inline]{I know that it may be not the focus here but I think that you could give more details of how Algorithms 1, 2 and 3 were implemented in the \charm LB framework. In other words, how those communications, sychronizations, and task migrations required by the algorithms work in \charm. Since we have some space left I think you may include these details here.}
...
We compare the performance of \packdrop to other strategies available on the \charm.
